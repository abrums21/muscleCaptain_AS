...
public class CustomToolBar extends LinearLayout implements View.OnClickListener {
    ...
    public CustomToolBar(Context mContext)
    {
        this(mContext, null);
    }

    public CustomToolBar(Context mContext, AttributeSet attrs)
    {
        this(mContext, attrs, 0);
    }

    public CustomToolBar(Context mContext, AttributeSet attrs, int defStyle)
    {
        super(mContext, attrs, defStyle);

        initView();

        //Set the content insets for this include_toolbar relative to layout direction.
//        setContentInsetsRelative(10, 10);
        ...
        if (attrs != null) {
             ...
             */
            final TintTypedArray a = TintTypedArray.obtainStyledAttributes(getContext(), attrs,
                    R.styleable.CustomToolBar, defStyle, 0);
            ...
            final String leftText = a.getString(R.styleable.CustomToolBar_leftTextTitle);
            if (leftText != null)
            {
                setLeftTextTitle(leftText);
            }

            final String rightText = a.getString(R.styleable.CustomToolBar_rightTextTitle);
            {
    ...
    private void initView() {
        ...
        if (mView == null) {
            ...
            //添加布局文件
            mView = mInflater.inflate(R.layout.ui_customtoolbar, null);
