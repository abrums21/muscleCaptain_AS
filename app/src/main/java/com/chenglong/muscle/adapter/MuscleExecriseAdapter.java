...
public class MuscleExecriseAdapter extends BaseAdapter {
    ...
    public MuscleExecriseAdapter(Context context, String[] name, int[] drawableIds) {
...
//				.displayer(new FadeInBitmapDisplayer(1000))//是否图片加载好后渐入的动画时间
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (null == convertView) {
            convertView = LayoutInflater.from(context).inflate(R.layout.item_execrise, parent, false);
