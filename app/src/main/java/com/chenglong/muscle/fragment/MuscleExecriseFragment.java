...
public class MuscleExecriseFragment extends Fragment implements OnClickListener, AnimatorListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        return inflater.inflate(R.layout.fragment_execrise, container, false);
    }
    ...
    void newActivity(int position) {
        Intent intent = new Intent(getActivity(), MuscleExecriseActivity.class);
