...
public class ToolLessonActivity extends Activity {
	...
	private final int[] trainImages = { R.drawable.tool_lession_sunday, R.drawable.tool_lession_monday, R.drawable.tool_lession_tuesday, R.drawable.tool_lession_wednesday,
			R.drawable.tool_lession_thursday, R.drawable.tool_lession_friday, R.drawable.tool_lession_satday};
